...
$sqltext = "INSERT INTO UZYTKOWNIK VALUES ((SELECT max(ID)+1 FROM UZYTKOWNIK), '" . $NICK ."', '" .$KONTAKT. "'," .$WIEK.", '" .$IMIE."', '".$NAZWISKO."',  '" .$PLEC."', " .$RANKING.", '" . $PREFEROWANY_KOLOR ."', (SELECT S.ID FROM SLAWNY_SZACHISTA S WHERE S.NAZWISKO = '".$ULUBIONY_SZACHISTA."'), (SELECT O.ID FROM OTWARCIE O WHERE O.NAZWA = '".$ULUBIONE_OTWARCIE."'), '" .$PREF_PORA."', '" .$PREF_RANKING_PRZECIWNIKA."', " .$PREF_WIEK_PRZECIWNIKA.")";
